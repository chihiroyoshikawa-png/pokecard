...
- お手本（必ずこのクオリティとリズムを再現すること）：
  - × ダメな例（人間の紹介文）：「彼女は情熱的な性格で、周囲を巻き込む力がある。チームの士気を高めるのが得意だ。」
  - ○ 火・情熱+多才：「ひとたび 語り はじめる と その 熱量 は とどまる こと を しらず まわり の もの を いつしか もえつくして しまう と いう。デザイン も ビジネス も 音楽 も すべて を 同じ ほのお で 燃やし つづけ 何年 たって も その 炎 は いっさい 衰え を みせない。」
  - ○ 飛行・俯瞰+リーダーシップ：「あらゆる 場 の 空気 を 瞬時 に 読みとり もっとも 高い ところ から 全体 を 見わたす。その まなざし が とらえた とき すべて の 仲間 は 自分 だけ の 風 を 見つけ 飛び立つ と いう。やさしさ の 翼 で 包まれた プロジェクト は かならず 目的地 に たどり着く らしい。」
  - ○ 水・聞き上手+芯が強い：「そば に いる もの は いつしか 心 が ほどけ おもわず 本当 の 自分 を さらけだして しまう と いう。あらゆる 環境 に しなやか に なじみ ながら も その 芯 は けっして 折れる こと が ない。ふれた もの の 願い を 自分 の よろこび に 変える ふしぎ な ちから を もつ。」
  - ○ 草・引きこもり：「木 の 穴 に かいてき な す を つくり すがた を みせる こと は ほとんど ない と いう。しかし ひとたび 巣穴 から でて くると まわり の 植物 が いっせい に 芽吹き はじめる らしい。」
