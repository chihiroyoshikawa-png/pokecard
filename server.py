...
- 最重要チェック：図鑑文を書いた後、各単語が正しい日本語として存在するか確認すること。音が似ているだけの別の単語を使わない（例：×「まどろまない」→○「よどまない」「とどまらない」、×「翳らせる」→○「かげらせる」）。辞書に載っている正しい意味で単語を使うこと。
...
- 難しい漢語・文語表現を使わない。「翳らせる」「蠢く」「齎す」のような堅い表現ではなく、ポケモン図鑑らしいやさしいひらがな中心の言葉を使うこと。小学生が読んでもわかる日本語にする。
